...
python run_minigrid_ppo_memt.py  --n_exp 3 --name abla --env_name ${ENV_NAME} --exp_name ${SLURM_JOB_ID}_4e_${N_EXPERTS}ae \
                            --n_epochs 200 --n_steps 2000  --n_episodes_test 16 --train_frequency 2000 --lr_actor 6e-3 --lr_critic 9e-3 \
...
# python run_minigrid_ppo_mt.py  --n_exp 3 --name abla\
