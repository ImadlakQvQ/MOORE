...
python run_minigrid_ppo_memt.py  --n_exp 9 --name TEST_ --env_name ${ENV_NAME} --exp_name ${SLURM_JOB_ID}_4e_${N_EXPERTS}ae \
                            ...
                            --critic_network MiniGridPPOMEMTActorNetwork --critic_n_features 128 --orthogonal --n_experts 4 \
                            --n_action_experts ${N_EXPERTS} --actor_network MiniGridPPOMEMTActorNetwork --actor_n_features 128 \
...
#                             --critic_network MiniGridPPOMEMTActorNetwork --critic_n_features 128 --orthogonal --n_experts 4 \
#                             --n_action_experts 4 --actor_network MiniGridPPOMEMTActorNetwork --actor_n_features 128 \
